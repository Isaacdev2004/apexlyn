        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
          <div>
            <SectionHeading
              ...
              description="See how APEXLyn's platforms fit your environment in a personalized 30-minute demo. Our enterprise architects will assess your current security state and show you exactly where we can add value."
              inView={inView}
