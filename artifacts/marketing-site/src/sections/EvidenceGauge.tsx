        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            <SectionHeading
              ...
              description="We don't ask clients to take our word for it. Every claim is backed by third-party audits, independent testing, and verifiable compliance reports accessible through our Trust Center."
              inView={inView}
              ...
              {certifications.map((cert) => (
                ...
                >
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-slate-900 text-xs font-semibold">{cert.name}</span>
                  </div>
                  <span className="text-slate-600 text-xs">{cert.desc}</span>
                </div>
              ))}
            </motion.div>
